...
--   有効日数(validity_days)はデフォルト 365日(1年)。エクセルに記載が無いため既定値。管理画面で変更可。
...
INSERT OR REPLACE INTO ticket_products (id, name, total_hours, price, validity_days, is_active, sort_order) VALUES
  ('tkp-meieki-ab-6',  '名駅防音室A・B共通チケット 6時間',  6,  7700, 365, 1, 10),
  ('tkp-meieki-ab-12', '名駅防音室A・B共通チケット 12時間', 12, 15400, 365, 1, 11),
  ('tkp-meieki-ab-19', '名駅防音室A・B共通チケット 19時間', 19, 23100, 365, 1, 12),
  ('tkp-meieki-ab-26', '名駅防音室A・B共通チケット 26時間', 26, 30800, 365, 1, 13);
