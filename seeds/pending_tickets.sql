...
-- 出典: 提供Excel Sheet2（8/25時点・最新）。1回=1時間で換算。補正済み:
...
INSERT OR IGNORE INTO pending_tickets (id,email,name,scope,remaining_hours,valid_until,legacy_code,note) VALUES ('pt-002','cherrymusiccampus3@gmail.com','岩瀬智美','ab',5,'__VALID_UNTIL__','3kfb','移行:AB共通　4回購入 コード3kfb');
INSERT OR IGNORE INTO pending_tickets (id,email,name,scope,remaining_hours,valid_until,legacy_code,note) VALUES ('pt-003','katorapa21@gmail.com','嘉藤佑亮','higashibetsuin',17,'__VALID_UNTIL__','bx4f','移行:東別院　5回購入 コードbx4f');
...
INSERT OR IGNORE INTO pending_tickets (id,email,name,scope,remaining_hours,valid_until,legacy_code,note) VALUES ('pt-016','shichiai@gmail.com','SHICHIAI','ab',7,'__VALID_UNTIL__','8u9w','移行:AB共通　19回購入 コード8u9w');
...
INSERT OR IGNORE INTO pending_tickets (id,email,name,scope,remaining_hours,valid_until,legacy_code,note) VALUES ('pt-029','tomoki.flute@gmail.com','堀田智貴','ab',19,'__VALID_UNTIL__','ngb7','移行:AB共通　1回購入 コードngb7');
...
INSERT OR IGNORE INTO pending_tickets (id,email,name,scope,remaining_hours,valid_until,legacy_code,note) VALUES ('pt-037','tatami_8_jyou@yahoo.co.jp','石原ゆいか','ab',1,'__VALID_UNTIL__','a5i7','移行:AB共通　3回購入 コードa5i7');
